...
//    // define colors
//    defaultBorderColor.setRgba(QRgb(95, 95, 95, 255));
//    currentItemColor.setRgb(Qt::yellow);
//    selectedColor.setRgb(Qt::yellow);
//    pickColor.setRgb(Qt::green);
//    cacheColor.setRgb(Qt::blue);

//    notPick.setRgb(defaultBorderColor);
//}
...
//    // define some offsets
//    paddingOffset(itemPadding, itemPadding);
//    itemBorderOffset(itemBorderThickness, itemBorderThickness);
//    thumbPaddingOffset(thumbBorderPadding, thumbBorderPadding);
//    thumbBorderOffset(thumbBorderThickness, thumbBorderThickness);
...
//    itemRect(option.rect.topLeft() + itemBorderOffset,
//                   option.rect.bottomRight() - itemBorderOffset);

//    selectedRect(itemRect.topLeft() + thumbBorderOffset,
//                       itemRect.bottomRight() - thumbBorderOffset);

//    // The thumb rect is padded inside the item rect
//    thumbRect(itemRect.topLeft() + thumbBorderOffset +
//                    paddingOffset + thumbPaddingOffset, thumbSize);

//    // the icon rect is aligned within the thumb rect
//    alignVertPad = (thumbRect.height() - iconsize.height()) / 2;
//    alignHorPad = (thumbRect.width() - iconsize.width()) / 2;
//    iconRect(thumbRect.left() + alignHorPad, thumbRect.top() + alignVertPad,
//                   iconsize.width(), iconsize.height());

//    // label/rating rect located top-right as containment for circle
//    ratingDiam = badgeSize;
//    ratingTextSize = badgeSize;
//    ratingTopLeft(option.rect.right() - ratingDiam, option.rect.top());
//    ratingBottomRight(option.rect.right(), option.rect.top() + ratingDiam);
//    ratingRect(ratingTopLeft, ratingBottomRight);

//    ratingTextTopLeft(ratingRect.left(), ratingRect.top() - 1);
//    ratingTextBottomRight(ratingRect.right(), ratingRect.bottom() - 1);
//    ratingTextRect(ratingTextTopLeft, ratingTextBottomRight);

//    // cached rect located bottom right as containment for circle
//    cacheDiam = 6;
//    cacheOffset = 3;
//    cacheTopLeft(thumbRect.right() - cacheDiam - cacheOffset,
//                        thumbRect.bottom() - cacheDiam - cacheOffset);
//    cacheBottomRight(thumbRect.right() - cacheOffset, thumbRect.bottom() - cacheOffset);
//    cacheRect(cacheTopLeft, cacheBottomRight);
...
//    yellow if current item or light gray if selected but not the current item, or
//    gray if not selected
//    */
//    QColor borderColor;
//    int borderThickness;
//    if (row == currentRow) {
//        borderColor = currentItemColor;
//        borderThickness = itemBorderThickness;
//    }
//    else {
//        borderColor = defaultBorderColor;
//        borderThickness = itemBorderThickness / 2;
//    }
//    QPen activePen(borderColor);
//    activePen.setWidth(borderThickness);
//    painter->setPen(activePen);
//    painter->drawRoundedRect(itemRect, 8, 8);

//    /* draw the selected rect inside the item rect and make it
//    light gray if selected.
//    */
