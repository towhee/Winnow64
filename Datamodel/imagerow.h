...
struct ImageRow
{
    ...
    qint32 searchId = -1, apertureId = -1, shutterId = -1, focalLengthId = -1;
    qint32 isoId = -1, dimensionsId = -1;
    ...
    // scalars
    qint64 byteSize = 0;
    qint32 width = 0, height = 0, rowNumber = 0;
    quint8 metaStatus = 0;
    bool   isVideo = false;
