...
public:
    ...
    void setupUi(QScrollArea *welcomeScrollArea)
    {
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 1326, 1865));
    ...
    void retranslateUi(QScrollArea *welcomeScrollArea)
    {
        ...
        tipsLabel->setText(QCoreApplication::translate("welcomeScrollArea", "<html><head/><body><p align=\"center\"><br/></p><p><span style=\" font-size:13pt; font-weight:600; color:#ffffff;\">Help</span><span style=\" font-size:13pt; color:#cccccc;\">: <br/>There are some help videos at the <a href=\"http://165.227.46.158/winnow/winnow.html\">Winnow website<span style=\" text-decoration: underline; color:#e5e5e5;\">.</span></p><p><span style=\" font-size:13pt; font-weight:600; color:#ffffff;\">Shortcuts</span><span style=\" font-size:13pt; color:#cccccc;\">: <br/>Most of the shortcuts are shown in the menus. You can see a complete list via the menu: </span><span style=\" font-size:13pt; font-style:italic; color:#cccccc;\">Help &gt; Shortcuts</span><span style=\" font-size:13pt; color:#cccccc;\">.</span></p><p><span style=\" font-size:13pt; font-weight:600; color:#ffffff;\">Workspaces</span><span style=\" font-size:13pt; color:#cccccc;\">: <br/>Check out workspaces to change to a different layout instantly. You can create workspaces and access them via Ctrl/Cmd 0-9.</span></p><p><span "
                        "style=\" font-size:13pt; font-weight:600; color:#ffffff;\">Panels</span><span style=\" font-size:13pt; color:#cccccc;\">: <br/>The panels will float or dock to the top, bottom, right or left sides of the main window.</span></p><p><span style=\" font-size:13pt; font-weight:600; color:#ffffff;\">Context Menus</span><span style=\" font-size:13pt; color:#cccccc;\">: <br/>Right mouse click to see context menus. Right clicking in the image panel (the one where this text resides) will show the main menu. This is handy when the main menu is hidden in full screen mode.</span></p><p><span style=\" font-size:13pt; font-weight:600; color:#ffffff;\">Tool tips</span><span style=\" font-size:13pt; color:#cccccc;\">: <br/>Hover over an item with the mouse to see a tool tip. Try this in the preferences dialog to see explanations for different settings.</span></p></body></html>", nullptr));
    } // retranslateUi
