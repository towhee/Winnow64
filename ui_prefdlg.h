...
public:
    ...
    void setupUi(QDialog *Prefdlg)
    {
        ...
        iconPaddingLbl = new QLabel(pageThumbnails);
        ...
        thumbSpacingLbl = new QLabel(pageThumbnails);
        thumbSpacingLbl->setObjectName(QString::fromUtf8("thumbSpacingLbl"));
        thumbSpacingLbl->setGeometry(QRect(420, 115, 30, 16));
        ...
        iconHeightLbl = new QLabel(pageThumbnails);
        iconHeightLbl->setObjectName(QString::fromUtf8("iconHeightLbl"));
        iconHeightLbl->setGeometry(QRect(380, 70, 30, 16));
        ...
        iconWidthLbl_2 = new QLabel(pageThumbnails);
        iconWidthLbl_2->setObjectName(QString::fromUtf8("iconWidthLbl_2"));
        iconWidthLbl_2->setGeometry(QRect(370, 290, 30, 16));
