...
int ImageCache2::keyFromPath(QString fPath)
{
...
*/
    ...
    while (room < roomRqd) {
        ...
        if (nextToDecache(id)) {
            ...
            emit updateCacheOnThumbs(s, false, "ImageCache2::makeRoom");
...
*/
    ...
    emit updateCacheOnThumbs(decoder[id]->fPath, true, "ImageCache2::cacheImage");
