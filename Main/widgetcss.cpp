...
{
    return  "QMainWindow::separator {"
            "background: " + QColor(bg+5,bg+5,bg+5).name() + ";"
            "width: 4px;"
            "height: 4px;"
            "}"
...
QString WidgetCSS::listWidget()
{
    ...
    "QListWidget {"
        ...
        "gridline-color: " + QColor(bg-10,bg-10,bg-10).name() + ";"
        "color: " + textColor.name() + ";"
        "selection-background-color: " + selectionColor.name() + ";"
        "border: 1px solid " + QColor(bg+10,bg+10,bg+10).name() + ";"
     "}";
}
...
QString WidgetCSS::treeWidget()
{
    return
    "QTreeWidget {"
        "alternate-background-color: " + QColor(bg+5,bg+5,bg+5).name() + ";"
        "border: 2px solid " + QColor(bg+10,bg+10,bg+10).name() + ";"
        "color: lightgray;"
    "}"
...
QString WidgetCSS::scrollBar()
{
    ...
    "QScrollBar:vertical {"
        "border: 2px solid " + QColor(bg+10,bg+10,bg+10).name() + ";"
        "background-color: " + QColor(bg-10,bg-10,bg-10).name() + ";"
        "margin-top: 0px;"
        "margin-bottom: 0px;"
    ...
    "QScrollBar::handle:vertical {"
        "border-right: 0px solid " + QColor(bg+10,bg+10,bg+10).name() + ";"
        "min-height: 20px;"
    ...
    "QScrollBar::add-line:vertical {"
        "border: 0px solid " + QColor(bg+10,bg+10,bg+10).name() + ";"
        "height: 0px;"
