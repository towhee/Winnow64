...
HEADERS += Dialogs/savedeveloppresetdlg.h
...
HEADERS += Dialogs/exportdlg.h
HEADERS += Export/exportpresets.h
HEADERS += Export/exportsettings.h
HEADERS += Export/imageexporter.h
HEADERS += Utilities/tokenfilename.h
HEADERS += Dialogs/selectionorpicksdlg.h
HEADERS += Dialogs/testaligndlg.h
HEADERS += Dialogs/tokendlg.h
HEADERS += Dialogs/updateAppDlg.h
...
HEADERS += Develop/Properties/developproperties.h
...
SOURCES += Dialogs/savedeveloppresetdlg.cpp
...
SOURCES += Dialogs/exportdlg.cpp
SOURCES += Export/exportpresets.cpp
SOURCES += Export/imageexporter.cpp
SOURCES += Utilities/tokenfilename.cpp
SOURCES += Dialogs/selectionorpicksdlg.cpp
SOURCES += Dialogs/testaligndlg.cpp
SOURCES += Dialogs/tokendlg.cpp
SOURCES += Dialogs/updateAppDlg.cpp
...
SOURCES += Develop/Properties/developproperties.cpp
